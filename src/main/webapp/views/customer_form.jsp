...
<%-- Auth guard: redirect to login if no session user --%>
<%
    ...
    Customer c = (Customer) request.getAttribute("customer");   // may be null in create
    boolean isEdit = "edit".equalsIgnoreCase(mode);
    String error = (String) request.getAttribute("error");

    // tiny HTML esc helper (no extra libs)
    String esc(String s) {
    if (s == null) return "";
...
<head>
    ...
    <style>
        ...
        .row textarea{flex:1; padding:8px; border:1px solid #ccc; border-radius:6px;}
